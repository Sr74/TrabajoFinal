...
<body>
    <header>
        <h1>Estas por adoptar una nueva mascota <br> ofavor confirma tu peticion, y asegurece de tener los datos necesarios del dueño</h1>
    </header>
    <form action="procesoadoptado.php" method="post">
        <div class="dorbe">
            ...
            <br>
            <div>
                <label>Ingrese su numero de DNI:</label>
                <input type="text" name="dni">
            </div>
            <br>
            <div>
                <label>Ingrese correo de contacto:</label>
                <input type="email">
            </div>
            <br>
            <div>
        ...
        <br>
        <div>
            <label><strong> Términos y Condiciones de Uso </strong></label><br>
    ...
    El usuario puede elegir y cambiar la clave para su acceso de administración de la cuenta en cualquier momento, en caso de que se haya registrado y que sea necesario para la compra de alguno de nuestros productos. hoay no asume la responsabilidad en caso de que entregue dicha clave a terceros.
    ...
    RESCUEPETS  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
    ...
    Este sitio web hoay garantiza que la información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.
                    
    La suscripción a boletines de correos electrónicos publicitarios es voluntaria y podría ser seleccionada al momento de crear su cuenta.
                    
    recuepets reserva los derechos de cambiar o de modificar estos términos sin previo aviso.
                    
    Estas terminos y condiciones se han generado en terminosycondicionesdeusoejemplo.com.
            </textarea><br>
            <input type="checkbox" name="condiciones" value="1"><label>Aceptar termino</label> 
        </div>
        <div>
